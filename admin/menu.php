	...
	<div class='sidebar-collapse'>
		<ul class='nav' id='main-menu' style='margin:0'>
			...
			<li style='margin:0'>
				...
				<ul class='nav nav-second-level' style='margin:0'>
					<li style='margin:0'>
						<a href='?module=settings'>Website</a>
					</li>
					<li style='margin:0'>
					...
					<li style='margin:0'>
						<a href='?module=tampilan'>Tampilan</a>
					</li>
					<li style='margin:0'>
						<a href='?module=sidebar'>Sidebar</a>
					</li>
					<li style='margin:0'>
						<a href='?module=widget'>Widget</a>
					</li>
					<li style='margin:0'>
			...
			<li style='margin:0'>
				<a href='?module=database'>&nbsp; <i class='fa fa-database fa-2x'></i> Database</a>
			</li>
			<li style='margin:0'>
				<a href='?module=sitemap'>&nbsp; <i class='fa fa-sitemap fa-2x'></i> Sitemap</a>
			</li>
		</ul>
	</div>
</nav>
